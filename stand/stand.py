...
def prostate():
    ...
    kos.actuator.command_actuators(
        [{"actuator_id": body["l_ankle"], "position": 100}, {"actuator_id": body["l_knee"], "position": 100}]
    )
    kos.actuator.command_actuators(
        [{"actuator_id": body["r_ankle"], "position": -100}, {"actuator_id": body["r_knee"], "position": -100}]
    )
    time.sleep(2)
    ...
    kos.actuator.command_actuators(
        [{"actuator_id": body["l_rotator"], "position": -45}, {"actuator_id": body["r_rotator"], "position": 42}]
    )

    kos.actuator.command_actuators(
        [{"actuator_id": body["l_thigh"], "position": -62}, {"actuator_id": body["r_thigh"], "position": 59}]
    )
    ...
    kos.actuator.command_actuators(
        [{"actuator_id": body["l_hamstring"], "position": 10}, {"actuator_id": body["r_hamstring"], "position": -26}]
    )

    time.sleep(2.5)

    kos.actuator.command_actuators(
        [{"actuator_id": body["l_hamstring"], "position": -23}, {"actuator_id": body["r_hamstring"], "position": 29}]
    )
    ...
    kos.actuator.command_actuators(
        [
            {"actuator_id": body["l_rotator"], "position": -70.876953125},
            {"actuator_id": body["r_rotator"], "position": 70.240234375},
        ]
    )

    kos.actuator.command_actuators(
        [{"actuator_id": body["l_shoulder"], "position": -45}, {"actuator_id": body["r_shoulder"], "position": 40}]
    )
    ...
    kos.actuator.command_actuators(
        [{"actuator_id": body["l_hip"], "position": 30}, {"actuator_id": body["r_hip"], "position": -28}]
    )

    kos.actuator.command_actuators(
        [{"actuator_id": body["l_rotator"], "position": 0}, {"actuator_id": body["r_rotator"], "position": 0}]
    )

    kos.actuator.command_actuators(
        [
            {"actuator_id": body["l_thigh"], "position": -62},
            {"actuator_id": body["l_hip"], "position": -5},
            {"actuator_id": body["l_hamstring"], "position": 15},
        ]
    )
